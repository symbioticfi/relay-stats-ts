...
export class ValidatorKey {
  constructor(public tag: number, public payload: Hex) {}
}
...
export class VaultVotingPower {
  constructor(public vault: Address, public votingPower: bigint) {}
}

/** @notice Operator voting power grouped by vaults. */
export class OperatorVotingPower {
  constructor(public operator: Address, public vaults: VaultVotingPower[]) {}
}

/** @notice Operator keys snapshot returned by the key registry. */
export class OperatorWithKeys {
  constructor(public operator: Address, public keys: ValidatorKey[]) {}
}
